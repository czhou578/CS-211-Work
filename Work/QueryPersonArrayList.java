...
public class QueryPersonArrayList {
	        ...
	        try{
	                ...
	                do{
	                    ...
	                    father = scan.nextLine();
	                        // FOR EACH loop to find the Person
	                        for(Person p: list){
	                        ...
	                        // FOR EACH loop to find the mother
	                        for(Person m: list){
	                            if(m.getName().equalsIgnoreCase(mother)) m.addChildren(name);
	                        } 
	                        // FOR EACH loop to find the FATHER
	                        for(Person d: list){
	                            if(d.getName().equalsIgnoreCase(father)) d.addChildren(name);
	                        }
